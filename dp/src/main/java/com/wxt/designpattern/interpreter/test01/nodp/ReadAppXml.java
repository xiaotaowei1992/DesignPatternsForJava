package com.wxt.designpattern.interpreter.test01.nodp;
...
public class ReadAppXml {
	...
	public void read2(String filePathName)throws Exception{
		Document doc = null;
		//建立一个解析器工厂
		DocumentBuilderFactory factory = DocumentBuilderFactory.newInstance();
		//获得一个DocumentBuilder对象，这个对象代表了具体的DOM解析器
		...
		for(int i=0;i<appXmlNode.getLength();i++){
			String applicationXml1 = appXmlNode.item(i).getFirstChild().getNodeValue();
			System.out.println("applicationXml=="+applicationXml1);
		}
	}
